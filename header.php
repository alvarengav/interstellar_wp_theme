		...
		<header class="blog-header">
			<nav class="navbar navbar-expand-lg navbar-dark bg-dark2">
				<a class="navbar-brand" href="<?php bloginfo('url') ?>">
					...
					$image = has_custom_logo() ? wp_get_attachment_image_src($custom_logo_id, 'full') : 'logo.png';
					?>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					?>
					<ul class="navbar-nav external-brands ml-auto mx-lg-5">
						<li id="github-brand" class="nav-item"><a href="#" class="nav-link">
